...
function refresh_data()
    ...
    if set == 'gfw_data' then
        refresh_cmd = 'wget https://cdn.jsdelivr.net/gh/gfwlist/gfwlist/gfwlist.txt -O /tmp/gfw.b64'
    ...
    elseif set == 'ip_data' then
        ...
        refresh_cmd = 'wget -O - https://easylist-downloads.adblockplus.org/easylistchina+easylist.txt > /tmp/adnew.conf'
        need_process = 1
        sret = luci.sys.call(refresh_cmd .. ' 2>/dev/null')
        if sret == 0 then
